...
class JobStreetGUI:
    ...
    def write_log(self, text: str):
        #DEBUG/LOG: Mengirim string log ke UI Tkinter (Thread-safe).
    ...
    def on_start_click(self):
        ...
        # JALANKAN THREAD: Menjalankan Playwright di background thread agar UI tidak freezing/lag
    ...
    async def _execute_scraping(self):
        ...
        self.write_log("==========================================")
        self.write_log(f"[START] Memulai Scraping untuk Keyword: '{query}'")
